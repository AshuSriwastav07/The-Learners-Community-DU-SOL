...
public class semester4PaidNotesFragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view= inflater.inflate(R.layout.fragment_semester4_paid_notes, container, false);
        RecyclerView recyclerView=view.findViewById(R.id.semester4PaidNotesRV);
        recyclerView.setLayoutManager(new LinearLayoutManager(view.getContext()));

        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference getDonationData = database.getReference("PaidNotesNewData/Sem4");

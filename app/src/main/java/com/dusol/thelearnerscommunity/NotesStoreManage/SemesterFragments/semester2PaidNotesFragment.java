...
public class semester2PaidNotesFragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view=inflater.inflate(R.layout.fragment_semester2_paid_notes, container, false);
        RecyclerView recyclerView=view.findViewById(R.id.semester2PaidNotesRV);
        recyclerView.setLayoutManager(new LinearLayoutManager(view.getContext()));

        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference getDonationData = database.getReference("PaidNotesNewData/Sem2");
